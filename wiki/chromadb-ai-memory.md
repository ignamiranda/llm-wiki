---
title: "ChromaDB AI Memory / ChromaDB AI记忆"
type: concept
language: en
created: 2026-06-11
modified: 2026-06-11
tags: [chromadb, persistent-memory, vector-database, ai-agents, mcp, recall, retrieval]
aliases: [chromadb-memory, chromadb-agent-memory]
summary: "A persistent memory system for AI coding agents backed by ChromaDB, implementing multi-strategy recall with vector search, BM25, temporal decay, and reciprocal rank fusion."
---

# ChromaDB AI Memory / ChromaDB AI记忆
